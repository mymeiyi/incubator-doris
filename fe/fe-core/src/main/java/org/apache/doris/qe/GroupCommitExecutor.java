...
public class GroupCommitExecutor implements CoordInterface {
    private static final Logger LOG = LogManager.getLogger(GroupCommitExecutor.class);
    ...
    public GroupCommitExecutor(ShortCircuitQueryContext ctx, int maxMessageSize) {
        ctx.sanitize();
