...
suite("test_schema_change") {
    ...
    // 5. modify column order (why modify this order?)
    sql """ alter table ${tableName} order by (`user_id`, `date`, `city`, `age`, `sex`, `max_dwell_time`, `comment`, `min_dwell_time`, `last_visit_date_not_null`, `cost`, `last_visit_date`, `last_update_date`); """
    {
        sql """ INSERT INTO ${tableName}
        (`user_id`, `date`, `city`, `age`, `sex`, `last_update_date`, `last_visit_date_not_null`,
        `cost`, `max_dwell_time`, `min_dwell_time`) 
