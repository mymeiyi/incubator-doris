...
suite("insert_group_commit_into_unique") {
    ...
    /**
     *  ------------------------------------------------------------------------------
     *  |      file               |  contain delete column | contain sequence_col | contain sequence_type |
     *  ------------------------------------------------------------------------------
     *  | test_group_commit_1.csv |          0             |        0             |
     *  | test_group_commit_2.csv |          1             |        0             |
     *  | test_group_commit_3.csv |          0             |        1             |
     *  | test_group_commit_4.csv |          1             |        1             |
     *  ------------------------------------------------------------------------------
     */
